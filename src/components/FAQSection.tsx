...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Absolutamente! Nossa equipe visita e verifica cada fornecedor antes de incluir no app. Garantimos que são empresas reais, com CNPJ ativo e boa reputação.",
  },
  {
    question: "Preciso ir presencialmente na 25 de Março?",
    answer:
      "Não necessariamente! Muitos fornecedores trabalham com envio para todo o Brasil. Você pode fazer pedidos pelo WhatsApp e receber em casa. Mas se quiser ir presencialmente, temos os endereços completos.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "O plano Básico dá acesso a 100+ fornecedores por 6 meses. O Premium inclui 500+ fornecedores, acesso vitalício e grupo VIP. O Business adiciona consultoria individual e networking exclusivo.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "O grupo VIP é onde acontece a mágica! Lá compartilhamos fornecedores exclusivos, dicas de negociação, alertas de oportunidades e você pode fazer networking com milhares de empreendedores.",
  },
];
